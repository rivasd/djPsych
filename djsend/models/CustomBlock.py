...
class RatingBlock(BaseSettingBlock):
    ...
    responses = models.CharField(max_length = 16, choices = (('boxes','boxes'),('slider','slider')), help_text=l_("Choice between displaying a slider or choices in boxes for response"))
