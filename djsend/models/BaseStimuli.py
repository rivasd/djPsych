...
class Question(BaseStimuli):
    ...
    answer_options = models.CharField( max_length = 1024, help_text=l_("Choose the labels for the possibles answers for each question. You have separate them with a semi-colon."))
