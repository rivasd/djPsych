...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('djsend', '0028_auto_20170103_1425'),
    ]

    operations = [
        migrations.CreateModel(
            name='ButtonResponseBlock',
            fields=[
                ...
                ('timing_stim', models.IntegerField(default=-1, help_text='How long to show the stimulus for in milliseconds. If the value is -1, then the stimulus will be shown until the subject makes a response.')),
