...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('djsend', '0040_auto_20170106_1449'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeout_message_timing', models.IntegerField(help_text='How long to show the feedback message for in milliseconds.')),
                ('timing_gap', models.IntegerField(help_text='How long to leave blank between the sounds.')),
