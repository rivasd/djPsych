# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-01-03 19:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('djsend', '0027_auto_20161227_1057'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frame_isi', models.IntegerField(default=0, help_text='If greater than 0, then a gap will be shown between each image in the sequence. This parameter specifies the length of the gap.')),
                ('sequence_reps', models.IntegerField(default=1, help_text='How many times to show the entire sequence. There will be no gap (other than the gap specified by frame_isi) between repetitions')),
