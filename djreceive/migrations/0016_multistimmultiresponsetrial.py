...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djreceive', '0015_freesorttrial'),
    ]

    operations = [
        migrations.CreateModel(
            name='MultiStimMultiResponseTrial',
            fields=[
                ...
                ('stimulus', jsonfield.fields.JSONField(blank=True)),
                ('key_press', jsonfield.fields.JSONField(blank=True)),
                ('rt', jsonfield.fields.JSONField(blank=True)),
